...
#include "../../runtime/gptJsonConfig.h"
#include "../../runtime/gptSession.h"
#include "../../runtime/tllmLogger.h"
#include "../../runtime/utils/multiDeviceUtils.h"
#include "../../runtime/utils/numpyUtils.h"
...
class ChatGlmSessionTest : public SessionTest
{
};

class ChatGlm2SessionTest : public SessionTest
{
};

class ChatGlm3SessionTest : public SessionTest
{
};
