    ...
    int64_t cublasWorkspaceSize, nvinfer1::DataType dataType, cudaStream_t stream)
{
    ...
    auto gemm_coord_size
        = bitfusion::common::divUp((size_t) problem_count * sizeof(cutlass::gemm::GemmCoord), (size_t) 16) * 16;
    auto ptr_size = bitfusion::common::divUp((size_t) problem_count * sizeof(half*), (size_t) 16) * 16;
    auto ldd_size = bitfusion::common::divUp((size_t) problem_count * sizeof(int64_t), (size_t) 16) * 16;
