...
#include "../../kernels/decoderMaskedMultiheadAttention/cubin/xqa_kernel_cubin.h"
...
protected:
    bitfusion::common::CUDADriverWrapper mDriver;
...
public:
    ...
    {
        int device_id = bitfusion::common::getDevice();
...
public:
    ...
    {
        mMultiProcessorCount = bitfusion::common::getMultiProcessorCount();
    }
...
DecoderXQARunner::DecoderXQARunner(
    ...
    : pimpl(new xqaImpl(data_type, bitfusion::common::getSMVersion()))
    , mNumHeads(num_heads)
