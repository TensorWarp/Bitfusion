    ...
    int* kernel_occupancy = nullptr)
{
    ...
    using EpilogueOp = typename bitfusion::cutlass_extensions::Epilogue<ElementType,
    ...
    {
        *kernel_occupancy = bitfusion::cutlass_extensions::compute_occupancy_for_kernel<GemmKernel>();
        return;
    }
...
MoeGemmRunner<T, WeightType>::MoeGemmRunner()
{
    ...
    sm_ = bitfusion::common::getSMVersion();
