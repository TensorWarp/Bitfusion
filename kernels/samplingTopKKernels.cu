...
namespace bitfusion
{
    namespace kernels
    {
            ...
            const bool* skipDecode)
        {
            ...
            const int batchId = bid / BLOCKS_PER_BEAM_;
            ...
            const int blockLane = bid % BLOCKS_PER_BEAM_;
...
#define CASE_K(K_MAX, BLOCK_SIZE_1_, BLOCK_SIZE_2_, BLOCKS_PER_BEAM_)                                                  \
    ...
    break;
            ...
            const int vocabSizePadded, const int* endIds, cudaStream_t stream, const int batchSize, const bool* skipDecode)
        {
            ...
            int tempLogProbsBufSize = batchSize * vocabSize;
            int topKTmpIdsBufSize = batchSize * maxTopK * maxBlockPerBeam;
            int topKTmpValBuf_size = batchSize * maxTopK * maxBlockPerBeam;
