...
using bitfusion::plugins::BertAttentionPluginCreator;
using bitfusion::plugins::BertAttentionPlugin;
    ...
    const nvinfer1::PluginTensorDesc* outputs, int nbOutputs) const noexcept
{
    ...
    auto const size = bitfusion::runtime::BufferDataType(inputs[0].type).getSize();
    ...
    cudaStream_t stream)
{
    ...
    const int attention_seq_len_1 = request_seq_len;
    const int attention_seq_len_2 = request_seq_len;
