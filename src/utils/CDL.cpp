...
/// <summary>
/// Function to validate the CDL configuration.
/// </summary>
/// <param name="config">The CDL configuration to validate.</param>
...
/// <summary>
/// Function to load and process plugins from a directory.
/// </summary>
/// <param name="pluginsDir">The directory path containing the plugins.</param>
...
int main(int argc, char* argv[]) {
    try {
        ...
        // Asynchronously parse the JSON configuration file.
        ...
        // Wait for the JSON parsing to complete and get the JSON value.
        Json::Value root = futureRoot.get();

        // Create a CDL configuration object using the parsed JSON.
        ...
        // Execute validation and plugin loading in separate threads.
