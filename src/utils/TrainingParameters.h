...
/// <summary>
/// Represents a configuration class for training parameters.
/// </summary>
...
public:
    ...
    /// <summary>
    /// Loads training parameters from a JSON configuration.
    /// </summary>
    /// <param name="root">The JSON configuration to load from.</param>
