...
void RecsGenerator::generateRecs(Network* xNetwork,
    ...
    if (getGpu()._id == 0) {
        ...
        std::cout << "Time Elapsed for Filtering and selecting Top " << xK << " recs: " << elapsed_seconds(start, now) << '\n';
        ...
        std::cout << "Time Elapsed for Writing to file: " << elapsed_seconds(start, end) << '\n';
    }
