...
class StatefulDecoder : public IStatefulDecoder
{
public:
    StatefulDecoder(std::size_t vocabSize, std::size_t vocabSizePadded, CudaStreamPtr stream);
