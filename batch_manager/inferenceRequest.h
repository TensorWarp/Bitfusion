...
#undef TENSOR_GETTER_SETTER
    ...
    class InferenceRequest : public GenericInferenceRequest<bitfusion::runtime::ITensor::SharedPtr, NamedTensor>
    {
    public:
        using Base = GenericInferenceRequest<bitfusion::runtime::ITensor::SharedPtr, NamedTensor>;
